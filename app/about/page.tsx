export default function About() {
  return (
    <div className="space-y-10 py-24 px-6 pb-10 max-w-screen-sm mx-auto">
      <div className="size-16 bg-zinc-500 rounded-full"></div>
      <h2 className="text-lg sm:text-2xl">About</h2>
      <p>
